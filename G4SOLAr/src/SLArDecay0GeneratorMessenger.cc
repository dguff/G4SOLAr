 ...
 * @file        SLArDecay0GeneratorMessenger
 * @created     lunedì gen 16, 2023 10:14:25 CET
 */
...
namespace bxdecay0_g4 {
  ...
  SLArDecay0GeneratorMessenger::~SLArDecay0GeneratorMessenger()
  {
  ...
  G4String SLArDecay0GeneratorMessenger::GetCurrentValue(G4UIcommand * command_)
  {
    std::cerr << "[trace] bxdecay0_g4::SLArDecay0GeneratorMessenger::GetCurrentValue: Entering...\n";
    G4String curValue;
    ...
    std::cerr << "[log] bxdecay0_g4::SLArDecay0GeneratorMessenger::GetCurrentValue: curValue='" << curValue << "'\n";
    return curValue;
  }
    
  void SLArDecay0GeneratorMessenger::SetNewValue(G4UIcommand * command_, G4String new_value_)
  {
    if (_pga_->IsTrace()) std::cerr << "[trace] bxdecay0_g4::SLArDecay0GeneratorMessenger::SetNewValue: Entering...\n";
    if (_pga_->IsDebug()) std::cerr << "[debug] bxdecay0_g4::SLArDecay0GeneratorMessenger::SetNewValue: "
    ...
    if (command_ == _pga_gtor_mdl_cmd_) {
      ...
      if (not error) {
        ...
        if (_pga_->IsDebug()) {
          ...
          std::cerr << "[error] bxdecay0_g4::SLArDecay0GeneratorMessenger::SetNewValue: "
    ...
    if (_pga_->IsTrace()) std::cerr << "[trace] bxdecay0_g4::SLArDecay0GeneratorMessenger::SetNewValue: Exiting...\n";
    return;
  }
