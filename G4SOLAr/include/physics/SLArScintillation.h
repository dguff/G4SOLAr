...
class SLArScintillation : public G4VRestDiscreteProcess
{
 public:
  ...
  G4GenericMessenger* scint_mesg_;
  G4double electricField_ = 0.5;
  // SLArScintillation Process has both PostStepDoIt (for energy
  ...
  // If set, the SLArScintillation process expects the user to have
  ...
  // Call by the user to set the SLArScintillationTrackInformation
  // to scintillation photon track

  G4bool GetScintillationTrackInfo() const;
  // Return the boolean for whether or not the
  // SLArScintillationTrackInformation is set to the scint. photon track
...
inline G4bool SLArScintillation::GetTrackSecondariesFirst() const
{
  return fTrackSecondariesFirst;
}

inline G4bool SLArScintillation::GetFiniteRiseTime() const
{
  return fFiniteRiseTime;
}

inline G4PhysicsTable* SLArScintillation::GetIntegralTable1() const
{
  return fIntegralTable1;
}

inline G4PhysicsTable* SLArScintillation::GetIntegralTable2() const
{
  return fIntegralTable2;
}

inline G4PhysicsTable* SLArScintillation::GetIntegralTable3() const
{
  return fIntegralTable3;
}

inline void SLArScintillation::AddSaturation(G4EmSaturation* sat)
{
  fEmSaturation = sat;
}

inline void SLArScintillation::RemoveSaturation() { fEmSaturation = nullptr; }

inline G4EmSaturation* SLArScintillation::GetSaturation() const
{
  return fEmSaturation;
}

inline G4bool SLArScintillation::GetScintillationByParticleType() const
{
  return fScintillationByParticleType;
}

inline G4bool SLArScintillation::GetScintillationTrackInfo() const
{
...
inline G4double SLArScintillation::bi_exp(G4double t, G4double tau1,
                                        G4double tau2)
{
