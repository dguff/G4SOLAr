 ...
 * @file        SLArDecay0GeneratorMessenger.hh
 * @created     Mon Jan 16, 2023 10:12:18 CET
 */

#ifndef SLARDECAY0GENERATORMESSENGER_HH

#define SLARDECAY0GENERATORMESSENGER_HH
...
namespace bxdecay0_g4 {
 ...
 ///
  ...
  public:
    ...
    SLArDecay0GeneratorMessenger(SLArDecay0GeneratorAction * );

    ~SLArDecay0GeneratorMessenger() override;
  ...
  private:
    ...
    SLArDecay0GeneratorAction * _pga_ = nullptr;    
...
#endif /* end of include guard SLARDECAY0GENERATORMESSENGER_HH */
